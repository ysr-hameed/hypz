            ...
            for (let i = 0; i < selectedFiles.length; i++) {
                ...
                const progressInterval = setInterval(() => {
                    ...
                    if (simulatedProgress < 90) {
                        const totalProgress =
                            fileProgressStart +
                            (simulatedProgress / 100) * fileProgressRange;
    ...
    return (
        <div className="space-y-6 content-wrapper content-loaded">
            ...
            <div>
                <Link
                    to="/buckets"
                    className="inline-flex items-center text-sm text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 mb-4 transition">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3 flex items-start gap-2">
                                ...
                                <p className="text-xs text-blue-700 dark:text-blue-300">
                                    ...
                                    <strong>{bucket?.name}</strong> bucket
                                </p>
                            </div>
